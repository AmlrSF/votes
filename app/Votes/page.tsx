...
const Votes = () => {
  ...
  const fetchTeachers = async () => {
    try {
      const response = await fetch("https://teacherhub-rho.vercel.app/api/teachers"); // Adjust the URL if necessary
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://teacherhub-rho.vercel.app/api/teachers", {
        method: "POST",
        headers: {
