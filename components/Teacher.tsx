...
export default function Teacher({
  ...
  const handleUpvote = async () => {
    ...
    try {
      const response = await fetch(`https://teacherhub-rho.vercel.app/api/teachers/${_id}/upvote`, {
        method: "POST",
        headers: {
  ...
  const handleDownvote = async () => {
    ...
    try {
      const response = await fetch(`https://teacherhub-rho.vercel.app/api/teachers/${_id}/downvote`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
