...
export default function Teacher({
  ...
  const handleUpvote = async () => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/teachers/${_id}/upvote`, {
        method: "POST",
        headers: {
  ...
  const handleDownvote = async () => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/teachers/${_id}/downvote`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
